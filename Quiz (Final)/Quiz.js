...
function showResults() {
    ...
    resultsElement.innerHTML = `Your final score is ${score}%!`;
...
const questions = [
  ...
  },
  {
    ...
    answers: [
      { text: 'The Phantom Zone', correct: false },
      { text: 'The Nether Realm', correct: false },
	    { text: 'The Quantam Realm', correct: true },
      { text: 'The Twilight Zone', correct: false }
    ...
    question: "Why did Peter Parker and his friends take a trip to Washington D.C.?",
    answers: [
      { text: 'Chess Club', correct: false },
      { text: 'Academic Decathlon', correct: true },
	    { text: 'Mock UN', correct: false },
      { text: 'College Visit', correct: false }
    ...
    answers: [
      { text: 'Immortal Kombat', correct: false },
